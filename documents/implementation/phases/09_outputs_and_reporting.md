...
- `analytics.c2_adoption_scorecard` – C2 exploratory scorecard (`snapshot_month`, `service_family`, `plan_variant`, `region`, `customer_tier`, `sku`, `active_subscriptions`, `new_subscriptions`, `arr_usd`, `total_quantity`, `avg_seats`) used in Metabase narratives.
